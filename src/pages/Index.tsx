    ...
    <div className="min-h-screen bg-white overflow-x-hidden" style={{ scrollBehavior: 'smooth' }}>
      ...
      <section id="hero" className="pt-32 pb-20 bg-gradient-to-br from-white via-sopfuel-gray/20 to-sopfuel-blue/5 relative overflow-hidden">
        ...
        <motion.div className="absolute inset-0 overflow-hidden">
          <motion.div 
            className="absolute -top-40 -right-40 w-80 h-80 bg-sopfuel-blue/5 rounded-full"
            animate={{ scale: [1, 1.1, 1], rotate: [0, 180, 360] }}
            transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
          />
          <motion.div 
            className="absolute -bottom-40 -left-40 w-80 h-80 bg-sopfuel-green/5 rounded-full"
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <motion.div 
                variants={fadeInUp}
                className="inline-flex items-center px-4 py-2 bg-sopfuel-blue/10 rounded-full mb-6"
                animate={pulseGlow}
              >
              ...
              >
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button 
                    variant="outline"
                    size="lg"
                    className="border-sopfuel-blue text-sopfuel-blue hover:bg-sopfuel-blue hover:text-white text-lg px-8 py-4 rounded-xl font-medium shadow-lg hover:shadow-xl transition-all duration-300 group"
                  >
            ...
            >
              <motion.div 
                className="bg-gradient-to-br from-sopfuel-blue/10 to-sopfuel-green/10 rounded-3xl p-8 backdrop-blur-sm shadow-2xl"
              ...
              >
                ...
                <motion.div 
                  className="absolute -bottom-4 -right-4 bg-sopfuel-green rounded-xl p-3 shadow-lg"
                  animate={{ 
                    y: [5, -5, 5],
                    rotate: [2, -2, 2]
                  }}
          ...
          >
            {features.map((feature, index) => (
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <Card className="border-0 shadow-lg hover:shadow-2xl transition-all duration-500 rounded-2xl group h-full">
                  <CardHeader className="text-center pb-4">
                    ...
                    >
                      <motion.div 
                        className="p-4 bg-sopfuel-blue/5 rounded-2xl group-hover:bg-sopfuel-blue/10 transition-all duration-300"
          ...
          <div className="max-w-2xl mx-auto">
            <AnimatedSection>
              <motion.div whileHover={{ scale: 1.02 }}>
                <Card className="border-0 shadow-xl rounded-2xl hover:shadow-2xl transition-all duration-500">
